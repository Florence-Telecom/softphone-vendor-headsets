...
const CyberAcoustics_1 = __importDefault(require("./vendor-implementations/CyberAcoustics/CyberAcoustics"));
...
const jabra_1 = __importDefault(require("./vendor-implementations/jabra/jabra"));
const jabra_native_1 = __importDefault(require("./vendor-implementations/jabra/jabra-native/jabra-native"));
const yealink_1 = __importDefault(require("./vendor-implementations/yealink/yealink"));
const vbet_1 = __importDefault(require("./vendor-implementations/vbet/vbet"));
const consumed_headset_events_1 = require("../types/consumed-headset-events");
...
class HeadsetService {
    constructor(config) {
        ...
        this.plantronics = plantronics_1.default.getInstance({ logger: this.logger, appName: config.appName });
        this.jabraNative = jabra_native_1.default.getInstance({ logger: this.logger });
        this.jabra = jabra_1.default.getInstance({ logger: this.logger });
        this.sennheiser = sennheiser_1.default.getInstance({
            logger: this.logger,
            appName: config.appName,
            createNew: config.createNew
        });
        this.yealink = yealink_1.default.getInstance({ logger: this.logger });
        this.vbet = vbet_1.default.getInstance({ logger: this.logger });
        this.cyberAcoustics = CyberAcoustics_1.default.getInstance({ logger: this.logger });
    ...
    subscribeToHeadsetEvents(implementation) {
        implementation.on(consumed_headset_events_1.HeadsetEvents.deviceAnsweredCall, this.handleDeviceAnsweredCall.bind(this));
        implementation.on(consumed_headset_events_1.HeadsetEvents.deviceRejectedCall, this.handleDeviceRejectedCall.bind(this));
        implementation.on(consumed_headset_events_1.HeadsetEvents.deviceEndedCall, this.handleDeviceEndedCall.bind(this));
        implementation.on(consumed_headset_events_1.HeadsetEvents.deviceMuteStatusChanged, this.handleDeviceMuteStatusChanged.bind(this));
        implementation.on(consumed_headset_events_1.HeadsetEvents.deviceHoldStatusChanged, this.handleDeviceHoldStatusChanged.bind(this));
    ...
    clearSelectedImplementation(clearReason) {
        ...
        this._headsetEvents$.next({ event: consumed_headset_events_1.HeadsetEvents.implementationChanged, payload: null });
    ...
    handleDeviceAnsweredCall(event) {
        ...
        this._headsetEvents$.next({ event: consumed_headset_events_1.HeadsetEvents.deviceAnsweredCall, payload: Object.assign({}, event.body) });
    }
    handleDeviceRejectedCall(event) {
        ...
        this._headsetEvents$.next({ event: consumed_headset_events_1.HeadsetEvents.deviceRejectedCall, payload: Object.assign({}, event.body) });
    }
    handleDeviceEndedCall(event) {
        ...
        this._headsetEvents$.next({ event: consumed_headset_events_1.HeadsetEvents.deviceEndedCall, payload: Object.assign({}, event.body) });
    }
    handleDeviceMuteStatusChanged(event) {
        ...
        this._headsetEvents$.next({ event: consumed_headset_events_1.HeadsetEvents.deviceMuteStatusChanged, payload: Object.assign({}, event.body) });
    }
    handleDeviceHoldStatusChanged(event) {
        ...
        this._headsetEvents$.next({ event: consumed_headset_events_1.HeadsetEvents.deviceHoldStatusChanged, payload: Object.assign({}, event.body) });
    }
    ...
    publishConnectionStatus() {
        this._headsetEvents$.next({ event: consumed_headset_events_1.HeadsetEvents.deviceConnectionStatusChanged, payload: this.connectionStatus() });
    }
    ...
    handleDeviceLogs(eventInfo) {
        ...
        this._headsetEvents$.next({ event: consumed_headset_events_1.HeadsetEvents.loggableEvent, payload: Object.assign({}, eventInfo.body) });
    }
