...
exports.EposBusylightController = exports.DEFAULT_BUSYLIGHT_COLORS = exports.BUSYLIGHT_BLINK_INTERVAL_MS = exports.EPOS_BUSYLIGHT_PRODUCT_ID = exports.EPOS_BUSYLIGHT_VENDOR_ID = void 0;
exports.EPOS_BUSYLIGHT_VENDOR_ID = 0x1395; // 5013 - Sennheiser Communications
exports.EPOS_BUSYLIGHT_PRODUCT_ID = 0x0074; // 116 - UI 20 BL USB
...
exports.BUSYLIGHT_BLINK_INTERVAL_MS = 500;
exports.DEFAULT_BUSYLIGHT_COLORS = {
...
class EposBusylightController {
    ...
    static requestDevice() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [device] = yield hid.requestDevice({
                filters: [{ vendorId: exports.EPOS_BUSYLIGHT_VENDOR_ID, productId: exports.EPOS_BUSYLIGHT_PRODUCT_ID }],
            });
            return device;
        });
    }
    ...
    static findGrantedDevice() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return devices.find(device => device.vendorId === exports.EPOS_BUSYLIGHT_VENDOR_ID && device.productId === exports.EPOS_BUSYLIGHT_PRODUCT_ID);
        });
    }
    get isConnected() {
        var _a;
    ...
    setPhase(phase, colors = exports.DEFAULT_BUSYLIGHT_COLORS) {
        return __awaiter(this, void 0, void 0, function* () {
            this.stopBlink();
            ...
            if (phase === 'ringing') {
                ...
                }, exports.BUSYLIGHT_BLINK_INTERVAL_MS);
                return;
            }
...
exports.EposBusylightController = EposBusylightController;
