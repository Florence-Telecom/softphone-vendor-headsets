...
class CyberAcousticsService extends vendor_implementation_1.VendorImplementation {
    constructor() {
        super(...arguments);
    ...
    isSupported() {
        const supported = window.navigator.hid && !(0, utils_1.isCefHosted)();
        return supported;
    }
...
exports.default = CyberAcousticsService;
